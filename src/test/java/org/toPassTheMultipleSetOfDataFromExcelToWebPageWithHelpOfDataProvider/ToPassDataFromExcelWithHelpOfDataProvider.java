package org.toPassTheMultipleSetOfDataFromExcelToWebPageWithHelpOfDataProvider;
...
public class ToPassDataFromExcelWithHelpOfDataProvider {
	...
	public String[][] datas() {
		ExcelReaderClass2 excel = new ExcelReaderClass2(".\\Excel\\KumaranEx5.xlsx", "QaDatas");
